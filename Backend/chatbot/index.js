...
async function addDataToPinecone() {
  ...
  const documentClasses = {
    ...
    get_acc: [
      ...
      "Find out all my account's name.",
      "Can you provide my account's name?",
      "give my cash account name.",
      "please provide my bank account details.",
      "provide my credit account name.",
      "please provide my debit account details.",
      "fetch my home account name.",
      "what are my accounts",
      "what are my account names",
      "get my account details",
      "get my account names",
      "how many accounts do I have?",
      "can you get me the account details for the account named 'home account'",
    ],
    get_u_email: [
      "what is my email address?",
      "what is my registered email?",
      "what is my email id?",
      "can you provide my email address?",
      "please tell me my mail id",
      "please tell my gmail",
      "what is my account email",
      "which email is linked to my account?",
      "what email is associated to this account?",
    ],
    get_u_pass: [
      "what is my password?",
      "what is my account password?",
      "what is my password for this account?",
      "can you provide my password?",
      "please tell me my password",
      "what is my secret key",
      "what is my account secret key",
      "what password is associated to this account?",
      "which password is linked to my account?",
      "get my password details",
    ],
    update_name: [
      "update my user name to 'Ahmed'",
      "change my name to 'Aliza'",
      "update my registered name to 'Fatima'",
      "change my name to 'Hassan'",
      "I want to update my user name to 'Zainab'",
      "update my user name from 'Bilal' to 'Muhammad Bilal'",
      "I want to update my user name",
      "update my user name",
      "change my name",
      "modify my name to 'Maryam'",
      "update my profile name to 'Ali'",
      "edit my user name to 'Khadija'",
      "change my account name to 'Ibrahim'",
      "switch my name to 'Saima'",
      "alter my name to 'Yusuf'",
      "rename myself to 'Zara'",
      "set my name to 'Musa'",
    ...
    update_pass: [
      ...
      "change my password to 'myNewPass'",
      "update my account password to 'secure123'",
      "change my password to 'abc123'",
      "I want to update my password to 'newSecurePass'",
      "update my password from 'oldPass' to 'newPass123'",
      "I need to change my password",
      "modify my password to 'SafePassword2025'",
      "edit my password to 'strongKey123'",
      "set my password to 'pass@2025'",
      "change my login password to 'P@ssw0rd123'",
      "update my password from 'oldPass123' to 'newPass456'",
      "change my password from 'abc123' to 'secure456'",
      "update my current password 'oldSecurePass' to 'newSecurePass'",
      "I want to change my password from 'mypassword' to 'newpassword123'",
      "modify my password from 'currentPass' to 'updatedKey2025'",
      "set my password to 'newPass2025', my current password is 'oldPass2024'",
      "replace my password from 'oldKey123' to 'newKey456'",
      "reset my password from 'tempPass' to 'secureEntry2025'",
      "switch my password from 'Login123' to 'Access456'",
    ],
    general: [
